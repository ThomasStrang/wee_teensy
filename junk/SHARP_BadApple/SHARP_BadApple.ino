...
Adafruit_SharpMem display(13, 11, 10, 400, 240, 3000000);
...
void readFile(){
    ...
    Serial.printf("Reading Bad Apple/");
    
    filelen = sizeof(bad_apple);
    filesize = filelen;
    ...
    while(filelen) {
      if(toSink == 0) {
        ...
        memcpy(compbuf, bad_apple, toRead);
        filelen -= toRead;
        toSink = toRead;
        sinkHead = 0;
      }
...
//    Serial.begin(115200);
    ...
    display.refresh();
    Serial.println("started display. Reading file.");
